...
import {
  fetchOneVideoStory,
  updateVideoStory,
} from "../../../services/VideoStories";

function EditVideoStorySingle() {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const fetchVideoStory = async () => {
    const { data, error } = await fetchOneVideoStory(id);
    if (error) {
        ...
        <div className="p-5 w-1/2 mx-auto pt-20">
          <Card>
            ...
            >
              ...
              <div>
                <div className="mb-2 block">
                  <Label htmlFor="description" value="Second Name" />
                </div>
                <TextInput
                  id="secondPersonName"
...
export default EditVideoStorySingle;
