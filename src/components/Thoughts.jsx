    ...
    <div className="">
              ...
              <div className=" w-full text-[16px] 2xl:text-[20px] sm:text-[16px] border cursor-pointer rounded-lg Boldy uppercase text-black ">
                <div className=" border w-fit h-min p-3 rounded-lg mt-2">
                  <NavLink to="/testimonials#head3" className="">
                    <button
                      type="button"
                      className="border-[#1c1c1c] border px-1 py-1 rounded-md   hover:text-[#1c1c1c] hover:bg-yellow-300 hover:border-yellow-300 transition-all ease-in duration-300 ml-[-10px] text-[20px] 2xl:h-[34px] 2xl:w-[134px] "
                    >
                      read more
                    </button>
                  </NavLink>
      ...
      <div className="bg-[#EDECE7]">
        <div className="h-[15vh] pt-20 flex text-md sm:flex-row justify-center items-center text-3xl sm:text-3xl  Boldy bg-cover gap-2 pb-10">
          <span className="text-[#1C1C1C] Actonia text-[40px] sm:text-[36px] 2xl:text-[64px] mb-12 mr-[-10px] sm:mr-[0]">our</span>
          <span className="text-[#FFCA00] Boldy text-[40px] sm:text-[48px] 2xl:text-[70px]">AWARDS</span>
          <span className="Actonia text-[40px] text-[#1C1C1C] sm:text-[36px] 2xl:text-[64px]">&</span>{" "}
