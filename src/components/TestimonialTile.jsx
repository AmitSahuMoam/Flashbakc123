...
function TestimonialTile({ name, title, content, img }) {
  ...
  return (
    <div className="mx-5 my-2 leading-normal">
      ...
      <div className="w-full text-2xl border cursor-pointer mb-2 ml-[-10px] mt-2 rounded-lg Boldy text-[#1c1c1c] Courier Prime">
      ...
      <div className="text-[#1c1c1c] uppercase Boldy text-lg mt-5 mb-0">
        {name}
      </div>
      <hr className="border-[#1c1c1c] mt-5" />
    </div>
  );
}
