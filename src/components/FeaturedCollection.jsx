            ...
            <div className="text-lg flex-col flex mt-5 sm:pl-10 pl-0 leading-normal">
              ...
              <div className="text-lg mt-10  cursor-pointer w-fit">
                <NavLink to="/aboutus">
                  ...
                  <button
                    type="button"
                    className="border-yellow-300 text-[20px] border h-[34px] w-[176px] rounded-md  px-1 hover:text-black hover:bg-yellow-300 hover:border-black transition-all ease-in duration-300 py-1"
                  >
                    more about us
                  </button>
                </NavLink>
