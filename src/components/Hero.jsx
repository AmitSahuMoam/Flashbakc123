function Hero() {
  return (
    <div className="bg-hero-pattern h-screen flex flex-auto bg-cover justify-center items-center text-white lg:text-5xl 2xl:text-[70px] text-[30px]  bg-top px-20 pb-12">
