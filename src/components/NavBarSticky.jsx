...
function NavBarSticky(props) {
  ...
  return (
    <div className="w-full">
          ...
          <ul className="nav__links text-white Courier Prime ml-auto mr-auto space-x-4 normal-case">
            <li className="nav__link">
              <Dropdown
                ...
                label={
                  <span className="text-[16px] 2xl:text-[20px]">Stories</span>
                }
                color="transparent"
              ...
              >
                <Dropdown.Item
                  as={NavLink}
                  to="/photostories"
                  className="Courier Prime block w-full px-4 py-2 text-left 2xl:text-[20px] text-[16px] normal-case"
                >
                  Photos
                </Dropdown.Item>
                <Dropdown.Item
            ...
            <li>
              <NavLink
                to="/aboutus"
                className="Courier Prime whitespace-nowrap text-[16px] 2xl:text-[20px]"
              >
                About Us
              </NavLink>
            </li>
            ...
            <li className="nav__link">
              <Dropdown
                className="Courier Prime "
                label={
                  <span className="text-[16px] 2xl:text-[20px]">More</span>
                }
                color="transparent"
                theme={{ floating: { target: "w-full" } }}
              >
      ...
      {/* Small Screen */}
      <div
        className={`flex flex-row w-screen justify-between overflow-hidden ${
        ...
        {isVisible && (
          <>
            {!open && (
              <div className="flex justify-between items-center fixed  right-2 px-5 navItems 2xl:pr-10 pr-5 pt-5 2xl:pt-10">
                <div className="flex">
                  <Link
                    to="/"
                    className="flex nav__logo no-underline sm:hidden"
                  >
                    <div className="gap-10 Courier">
                      <img
                        src={logo}
                        alt=""
                        className="w-[10vh] fixed top-5 left-5"
                      />
                    </div>
                  </Link>
                </div>
                <div className="flex">
                  {isGetButtonVisible && (
                    <Link
                      to="/aboutus#contact"
                      type="button"
                      className="sm:flex hidden flex-row items-center bg-[#ffca00] cursor-pointer w-[140px] 2xl:w-[164px] sm:h-[29px] 2xl:h-[34px] rounded text-[#1c1c1c] overflow-hidden hover:text-yellow-300 hover:bg-[#1c1c1c] hover:border-yellow-300 transition-all ease-in duration-300 pt-2 px-2 py-2"
                    >
                      <span className="mr-2 Boldy flex items-center justify-center z-50 sm:text-[16px] 2xl:text-[20px]">
                        GET{" "}
                      </span>
                      <div
                        className="flex items-center justify-center Boldy sm:text-[16px] 2xl:text-[20px]"
                        key={CurrentStuff}
                      >
                        <MovingComponent
                          id="moving"
                  ...
                  <div className="lg:hidden ml-2 pb-10 ">
                    <IconButton
                      variant="outlined"
                      color="neutral"
            ...
            <Drawer open={open} onClose={() => setOpen(false)} size="lg">
              ...
              >
                <div className="ml-4">
                  <span className="Courier Prime text-[16px] 2xl:text-[20px] text-[#4A4A4A]">
                    Stories
                  </span>
                  <div
                    style={{
                    ...
                    <div>
                      <ListItemButton>
                        <NavLink
                          ...
                          className="Courier Prime 2xl:text-[20px] text-[16px]"
                        >
                          Photos
                        </NavLink>
                      </ListItemButton>
                ...
                <ListItemButton>
                  <NavLink
                    ...
                    to="/aboutus#contact"
                    className="Courier Prime 2xl:text-[20px] text-[16px] text-[#f3cc2e]"
                  >
                    Get in touch
                  </NavLink>
                </ListItemButton>
