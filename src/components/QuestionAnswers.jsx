...
function QuestionAnswers({ question, answer }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:w-[90%] sm:ml-0 mx-10 mt-5 justify-center">
      <p className="Boldy flex-1  text-[#FFCA00]  sm:mr-5 text-[24px] sm:text-left 2xl:text-right sm:max-w-[304px] uppercase Boldy sm:text-3xl leading-normal break-normal whitespace-normal">
      ...
      <p className="Courier Prime flex-[3] text-[#D8CAB1] Courier Prime  sm:max-w-[985px] 2xl:text-[18px] text-[16px] leading-normal">
        {answer}
      </p>
    </div> 
  );
