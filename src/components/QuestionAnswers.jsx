...
function QuestionAnswers({ question, answer }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:w-[90%] sm:ml-0 mx-10 mt-5 justify-center">
      <p className="Boldy flex-1  text-[#FFCA00] sm:text-right sm:mr-5 text-[24px] 2xl:text-right sm:max-w-[304px] uppercase Boldy sm:text-3xl leading-normal  whitespace-normal break-words">
